		...
		<form class="cl">
			<table align="center" style="padding-left: 5px; padding-right: 5px; padding-top: 5px; width: 364px; padding-bottom: 5px; word-spacing: normal">
				...
				<tr>
					...
					<td><input class="al" name="unit_contact" type="text"></td>
				</tr>

				<tr>
					<td><span class="fo">手机号码</span></td>
					<td><input class="al" name="unit_telnumber" type="text"></td>
				</tr>
				...
				<tr>
					...
					<td><input class="al" name="unit_username"></td>
				</tr>

				<tr>
					<td><span class="fo">密码</span></td>
					<td><input class="al" name="unitpasswd" type="password"></td>
				</tr>

				<tr align="center">
					<td colspan="2"><input type="submit" class="reg" value="注册">
						<input type="reset" class="reg" value="重置"></td>
				</tr>
			</table>
		</form>
		已有账号？<a href="log.jsp" class="sty">前往登陆</a>
	</center>
